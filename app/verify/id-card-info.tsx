...
export default function IdCardInfo({ identityInfo, onConfirm, onCancel }: IdCardInfoProps) {
  const router = useRouter();
  const dispatch = useAppDispatch();
  const [editableInfo, setEditableInfo] = useState<IdentityInfo>(identityInfo);
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
      <h2 className="text-xl font-semibold mb-4">Xác nhận thông tin CCCD</h2>

      {/* Thông báo */}
      <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg mb-6">
        <p className="text-sm text-orange-800">
          Bạn hãy kiểm tra lại thông tin xem có khớp với thông tin trong căn cước của bạn không? Nếu không vui lòng sửa lại. 
          Bạn hãy đảm bảo trung thực thông tin cá nhân của bạn đúng với thông tin trong căn cước của bạn, vì thông tin này không được sửa lại. 
          Nếu bạn khai sai sự thật hoặc có hành vi gian dối thì bạn sẽ phải tự chịu trách nhiệm trước pháp luật.
        </p>
      </div>
